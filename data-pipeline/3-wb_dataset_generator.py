...
def main():
    ...
    WLB_TEST_SET_PATH = "/home/roboy/Projects/RoboyMedium/data/test_hdf5_130100/"
    WLB_TRAIN_SET_PATH = "/home/roboy/Projects/RoboyMedium/data/train_hdf5_130100/"
    ...
    for file in dataset_files:
        ...
        for index, row in dataset.iloc[5000:10000].iterrows():
    ...
    def write_to_wlb_hdf(path, filename, input_data, label_data):
        ...
        label_shape = (len(input_data), 130, 100, 13)
    ...
    for i in range(number_of_elements):
        ...
        heatmaps_wlb = generate_heatmap(130, 100,
                                        landmarks,
                                        sigma=5
                                        )
